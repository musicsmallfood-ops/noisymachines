...
const SCALE_FACTOR_POSITIVE = 1;
const SCALE_FACTOR_NEGATIVE = -1;
...
const TRANSFORM_TRANSLATE_PART = "translate";
const TRANSFORM_SCALE_PART = "scale";
const OPEN_PAREN = "(";
const CLOSE_PAREN = ")";
const COMMA_SPACE = ", ";
...
function updateLogoFlipping() {
    ...
    const horizontalScale = shouldFlipHorizontal ? SCALE_FACTOR_NEGATIVE : SCALE_FACTOR_POSITIVE;
    const verticalScale = shouldFlipVertical ? SCALE_FACTOR_NEGATIVE : SCALE_FACTOR_POSITIVE;

    tvLogo.style.transform =
        TRANSFORM_TRANSLATE_PART + OPEN_PAREN + TRANSFORM_OFFSET + COMMA_SPACE + TRANSFORM_OFFSET + CLOSE_PAREN +
        SPACE_CHARACTER +
        TRANSFORM_SCALE_PART + OPEN_PAREN + horizontalScale + COMMA_SPACE + verticalScale + CLOSE_PAREN;
}
